...
class _ScreenState extends State<QuestionScreen52> {
  ...
  void Calcultion() {
    double Num1 = controll1.text.trim().isEmpty
        ? 0.0
        : double.parse(controll1.text.trim().toString());
    double Num2 = controll2.text.trim().isEmpty
        ? 0.0
        : double.parse(controll2.text.trim().toString());
